Module modInsteon
    ...
    Sub InsteonSendExtCommand(ByVal strAddress As String, ByVal comm1 As Byte, ByVal comm2 As Byte)
        SyncLock serialLock
            If My.Settings.Insteon_Enable = True Then
                If SerialPLM.IsOpen = True Then
                    If strAddress IsNot Nothing AndAlso IsInsteonAddress(strAddress) Then
                        Dim data(21) As Byte
                    ...
                    Else
                        My.Application.Log.WriteEntry("Command not sent, valid Insteon address not provided", TraceEventType.Warning)
                    End If
                Else
    ...
    ''' </summary>
    ''' <param name="strAddress">Insteon address of device</param>
    ...
    Function InsteonDoorSensorResponse(ByVal strAddress As String, ByVal comm1 As Byte, ByVal comm2 As Byte) As String
        ...
        Select Case comm1
            Case 17
                ...
                modDatabase.AddOrUpdateDoor(strAddress, "open")
            ...
            Case 19
                My.Settings.Global_TimeDoorLastOpened = Now()
                modDatabase.AddOrUpdateDoor(strAddress, "closed")
                Return "Door Closed"
            Case Else
