...
Module modStreamDeck
    ...
    Private Sub SetStreamDeckKeys()
        If KeyCount = 15 Then
            Dim iconLock = KeyBitmap.Create.FromFile("assets\modStreamDeck\Lock.png")
            ActiveStreamDeck.SetKeyBitmap(0, iconLock)
            Dim iconMusic = KeyBitmap.Create.FromFile("assets\modStreamDeck\Music.png")
            ActiveStreamDeck.SetKeyBitmap(1, iconMusic)
            Dim iconUrgent = KeyBitmap.Create.FromFile("assets\modStreamDeck\Urgent.png")
            ActiveStreamDeck.SetKeyBitmap(4, iconUrgent)
            Dim iconPrevious = KeyBitmap.Create.FromFile("assets\modStreamDeck\Previous.png")
            ActiveStreamDeck.SetKeyBitmap(5, iconPrevious)
            Dim iconPause = KeyBitmap.Create.FromFile("assets\modStreamDeck\Pause.png")
            ActiveStreamDeck.SetKeyBitmap(6, iconPause)
            Dim iconPlay = KeyBitmap.Create.FromFile("assets\modStreamDeck\Play.png")
            ActiveStreamDeck.SetKeyBitmap(7, iconPlay)
            Dim iconNext = KeyBitmap.Create.FromFile("assets\modStreamDeck\Next.png")
            ActiveStreamDeck.SetKeyBitmap(8, iconNext)
            Dim iconRestart = KeyBitmap.Create.FromFile("assets\modStreamDeck\Restart.png")
            ActiveStreamDeck.SetKeyBitmap(9, iconRestart)
            Dim iconPower = KeyBitmap.Create.FromFile("assets\modStreamDeck\Power.png")
