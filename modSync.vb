    ...
    Function SendMessage(ByVal strDestination As String, ByVal strMessageType As String, ByVal strMessage As String) As String
        If My.Settings.Sync_Enable = True Then
            If modGlobal.IsOnline = True Then
                ...
                Dim TargetUri As New Uri(My.Settings.Sync_ServerURL & "?message_type=" & strMessageType & "&destination=" & strDestination & "&access_key=" & My.Settings.Sync_AccessKey & "&message=" & strMessage & "&user_agent=HAController/" & My.Application.Info.Version.ToString)
